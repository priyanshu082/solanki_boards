...
import { getAllStudentsPayments } from '@/Config'
...
const ShowPayments = () => {
    ...
    const fetchPayments = async (page: number = currentPage, filterParams: FilterParams = filters) => {
        try {
            ...
            const response = await axios.post(getAllStudentsPayments, {
                skip,
                limit,
                        ...
                        {payments.map((payment) => (
                            <TableRow key={payment.id}>
                                ...
                                <TableCell className="text-right">
                                    <Button
                                        variant="outline"
                                        onClick={() => navigate(`/payment?id=${payment.paymentType === PaymentType.INSTITUTE ? payment.instituteId : payment.studentId}&type=${payment.paymentType}`)}
                                    >
                                        View Details
                                    </Button>
                                </TableCell>
